...
Recodifica la variables (i)  vote de tal forma que tenga el valor de 1 cuando el legislador votó a favor y 0 en cualquier otro caso y (ii) democrat para que tenga el valor de 1 para un legislador demócrata y 0 en cualquier otro caso.  (5 pts.)

Estima un modelo con una función de distribución acumulada logística que te permita probar las siguientes hipótesis:
...
Presenta los resultados de tu modelo en una tabla.  (5 pts.)

Interpreta substantivamente los resultados de forma que te permitan validar o rechazar las hipótesis nulas.  (10 pts.)

Presenta resultados que evalúen las hipótesis utilizando gráficas de probabilidades esperadas/predicciones. (15 pts.)
...
Genera un histograma de la variable breaks y explica que tipo de distribución observas en ella. (5 pts.)

Estima la media y la varianza de la variable breaks.  (5 pts.)

Calcula un modelo que permita predecir la frecuencia con la que se rompe un hilo como función del tipo de lana y el nivel de tensión.  (10 pts.)

Explica detalladamente por qué decidiste usar ese modelo en lugar de otros (i.e. por ejemplo un modelo BN en lugar de OLS ó un modelo Poisson en lugar de un BN). (10 pts.)

Interpreta substantivamente el (los) coeficientes de tensión.  (10 pts.)
