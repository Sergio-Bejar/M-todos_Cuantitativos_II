...
Este es el segundo curso de la secuencia en métodos cuantitativos para la licenciatura en Ciencia Política y Relaciones Internacionales del CIDE. En el primer curso de métodos te familiarizaste con el uso de `R` y `RStudio` para manipular datos y aprendiste conceptos básicos de estadística y probabilidad. Esos conocimientos son muy útiles porque nos permiten identificar patrones en los datos. En algunos casos dichos patrones son claros. En otros no tanto, y nos toca a nosotros encontrar formas que nos permitan distinguir patrones regulares en los datos del "ruido". El "ruido" ó error aleatorio es común en casi todas las bases de datos. Durante el semestre nos enfocaremos en aprender una serie de herramientas conceptuales y técnicas que te ayudarán a evaluar relaciones causales (el efecto de una o más variables sobre otra) de manera sistemática. Esto no solo te ayudará a explorar preguntas relevantes en nuestro campo de estudio usando métodos cuantitativos, sino también te facilitarán el entendimiento de artículos que leerás en otras clases y que usan métodos estadísticos para probar hipótesis. 

# Objetivos 

1. Conocer y comprender los obstáculos y retos a los que nos enfrentamos cuándo hacemos análisis con información que es incompleta e imperfecta (algo muy común en las ciencias sociales); 

2. Entender qué es la inferencia causal;

3. Modelar relaciones causales entre dos o más variables; 

4. Interpretar los resultados de tus modelos de forma sustantiva;

5. Aprender a comunicar los resultados de tus modelos estadísticos de forma persuasiva;
...
El contenido más importante de esta clase proviene de las sesiones presenciales y los ejercicios grupales durante ellas. Debido a lo anterior y al alto grado técnico de este curso es extremadamente importante que asistas a clase. Las ausencias injustificadas disminuirán tu calificación de participación. Si por algún motivo tienes que ausentarte, te sugiero que te pongas en contacto con tus colegas para ponerte al tanto de los temas tratados y actividades en clase. 
...
Realizaremos cuatro (4) exámenes durante el semestre. Las fechas están marcadas en el calendario del curso. No habrá exámenes de reposición a menos que cuentes con un justificante de causa mayor. Los archivos con las respuestas del exámen deberán ser entregados al finalizar la sesión y deberán ser etiquetados con la fecha y el apellido del estudiante (DDMMAA_Apellido). Respuestas tardías recibirán una calificación de 1. 
...
## Febrero 12: Repaso de Probabilidad

- A, sección 4.1
- DBC, secciones 2.1 y 2.2

## Febrero 14: Distribuciones de Probabilidad
...
## Febrero 19: Poblaciones, Muestras y Estimadores

- A, secciones 4.4 - 4.6
- DBC, secciones 2.3 - 2.5 y 4.1
- IK, capítulo 8

## Febrero 21: Estimadores Puntuales e Intervalos de Confianza
...
## Febrero 28: Pruebas de Hipótesis I
...
## Marzo 4: Pruebas de Hipótesis II
...
## Marzo 6: Pruebas de Hipótesis III
...
## Marzo 20: Mínimos Cuadrados Ordinarios

- Agresti, secciones 9.2 - 9.6
- DBC, sección 7.2

## Marzo 25: No hay clase

## Marzo 27: No hay clase

## Abril 1: Inferencia en Regresión Lineal I

- A, secciones 9.2 - 9.6
- DBC, secciones 7.2 - 7.4 

## Abril 3: Inferencia en Regresión Lineal II
